...
public class Result2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i=0;i<flightList.getSize();i++){
            if (flightList.getFlightByNum(i).getDeparture().equals("shanghai")&&flightList.getFlightByNum(i).getArrival().equals("beijing")){
                flightArrayList.add(flightList.getFlightByNum(i));
            }
        }

        recyclerView=findViewById(R.id.FlightsRecView2);
