...
public class Result4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i=0;i<flightList.getSize();i++){
            if (flightList.getFlightByNum(i).getDeparture().equals("copenhagen")&&flightList.getFlightByNum(i).getArrival().equals("beijing")){
                flightArrayList.add(flightList.getFlightByNum(i));
            }
        }

        recyclerView=findViewById(R.id.FlightsRecView4);
